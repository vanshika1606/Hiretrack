    ...
    <nav className="px-6 py-4 flex items-center justify-between sticky top-0 z-40 backdrop-blur-2xl" style={{background: 'rgba(6,6,8,0.7)', borderBottom: '1px solid rgba(255,255,255,0.04)'}}>
      ...
      <div className="flex items-center gap-1 px-1 py-1 rounded-xl" style={{background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)'}}>
        <button
          ...
          style={activeTab === 'board' ? {background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', color: 'white', boxShadow: '0 0 15px rgba(99,102,241,0.3)'} : {color: 'rgba(255,255,255,0.4)'}}>
          📋 Board
        </button>
        <button
          onClick={() => setActiveTab('ai')}
          className="px-4 py-1.5 rounded-lg text-xs font-semibold transition-all"
          style={activeTab === 'ai' ? {background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', color: 'white', boxShadow: '0 0 15px rgba(99,102,241,0.3)'} : {color: 'rgba(255,255,255,0.4)'}}>
          🤖 AI Match
        </button>
      </div>
